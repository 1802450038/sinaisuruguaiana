...
<form action="pmb_cms_senha_alterar.php" method="post" name="formulario" onSubmit="return validadados()">
	...
	<tr>
        ...
        <tr><td><br></td></tr>
	<tr>
	    <td><label>Nova senha </label><input type="password" name="novasenha" maxlength="10"><small>(somente numeros)</small></td></tr>
        <tr><td><br></td></tr>
	<tr>
	    <td><label>Confirmar nova senha </label><input type="password" name="confirmasenha" maxlength="10"><small>(somente numeros)</small></td></tr>
        <tr><td><br></td></tr>
	<tr>
