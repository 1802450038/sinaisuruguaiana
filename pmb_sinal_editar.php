...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
	$sql = "select idlocalidade, idprodutor, idprodutorsecundario, idprodutorterciario, idprodutorquaternario, observacao, numero, caminho from cms_sinais where idsinal = " . $id;
